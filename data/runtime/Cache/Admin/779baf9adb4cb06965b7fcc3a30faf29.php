        ...
        <table cellpadding="2" cellspacing="2" class="table_form" width="100%">
          <tbody>
            <tr>
              <td>分类名称:</td>
              <td>
              	<input type="text" class="input" name="cat_name" value="<?php echo ($cat_name); ?>"><span class="must_red">*</span>
              	<input type="hidden" class="input" name="cid" value="<?php echo ($cid); ?>">
              </td>
            </tr>
            <tr>
              <td>分类标识:</td>
              <td><input type="text" class="input" name="cat_idname" value="<?php echo ($cat_idname); ?>"><span class="must_red">*</span><span style="margin-left:15px;">英文字母+数字+“_”</span></td>
            </tr>
            <tr>
              <td>备注:</td>
              <td><textarea name="cat_remark" rows="5" cols="57"><?php echo ($cat_remark); ?></textarea></td>
            </tr>
          </tbody>
        </table>
      </div>
