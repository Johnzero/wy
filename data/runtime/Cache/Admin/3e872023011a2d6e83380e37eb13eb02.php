...
<div class="wrap J_check_wrap">
  ...
  <form class="form-horizontal J_ajaxForm" action="<?php echo U('authorize/edit_post');?>" method="post" id="myform">
  <div class="table_full">
      <table width="100%" cellpadding="2" cellspacing="2">

        <tr>
          <th width="180">姓名：</th>
          <td><input type="text" name="username" value="<?php echo ($data["username"]); ?>" class="input"></input><span class="must_red">*</span></td>
        </tr>

        <tr>
          <th width="180">授权号：</th>
          <td><input type="text" name="uid" value="<?php echo ($data["uid"]); ?>" class="input"></input><span class="must_red">*</span></td>
        </tr>

        <tr>
          <th width="180">微信号：</th>
          <td><input type="text" name="wechat_name" value="<?php echo ($data["wechat_name"]); ?>" class="input"></input><span class="must_red">*</span></td>
        </tr>
        ...
        <tr>
          ...
          <td>
            ...
            <script type="text/plain" id="content" name="authorize"><?php echo ($data["authorize"]); ?></script>
            <script type="text/javascript">
                //编辑器路径定义
